...
6) **REMOVE DIMENSION LINES**: Do not render any dimension lines or markers. They should be removed entirely, leaving only the architectural elements.
...
- Global illumination with soft natural daylight.
- Realistic shadow falloff and ambient light bounce between walls and floors.
`.trim();